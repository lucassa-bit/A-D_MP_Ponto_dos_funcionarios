    ...
    headers: {'Authorization': 'Bearer ' + localStorage.getItem("token")
        ...
        funcionarios.map((val) => {
            ...
            <div class="main2">
                ...
                <div style="cursor:pointer;" class="nome_funcionario">  <input class="checkbox"type="checkbox">` + val.empregado.nome + `
        ...
        for (var i = 0; i < nomesFuncionarios.length; i++) {
          ...
          nomesFuncionarios[i].addEventListener('click', e =>{
              if (e.target.querySelector('.informacoesExtras').style.display == 'none'){
